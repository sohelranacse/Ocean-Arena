		...
		<section class="about-section">
			<div class="container">
				<div class="col-md-offset-1 col-md-10 top-header-page">
					<h1 class="text-center wow fadeIn" data-wow-delay="100ms">ABOUT US</h1>
		...
		<section class="about-section-3">
			<div class="container">
				<div class="about-arena-feature wow fadeIn" data-wow-delay="300ms">
					<h3><img src="<?php echo base_url(); ?>web_assets/img/icons/glasses.png">What Ocean Arena Travels Offers You</h3>
		...
		<script src="<?php echo base_url(); ?>web_assets/js/hammer.min.js"></script> <!-- HAMMER GALLERY JS-->
		<script src="<?php echo base_url(); ?>web_assets/js/gallery.js"></script> <!-- GALLERY JS-->
